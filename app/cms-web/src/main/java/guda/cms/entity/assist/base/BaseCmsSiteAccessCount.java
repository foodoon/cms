...
public abstract class BaseCmsSiteAccessCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSiteAccessCount)) return false;
		else {
			guda.cms.entity.assist.CmsSiteAccessCount cmsSiteAccessCount = (guda.cms.entity.assist.CmsSiteAccessCount) obj;
