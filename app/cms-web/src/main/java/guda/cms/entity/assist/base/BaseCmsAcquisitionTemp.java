...
public abstract class BaseCmsAcquisitionTemp  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsAcquisitionTemp)) return false;
		else {
			guda.cms.entity.assist.CmsAcquisitionTemp cmsAcquisitionTemp = (guda.cms.entity.assist.CmsAcquisitionTemp) obj;
