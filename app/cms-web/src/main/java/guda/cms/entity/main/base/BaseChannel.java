...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		guda.cms.entity.main.CmsModel model,
	...
	// one to one
	private guda.cms.entity.main.ChannelExt channelExt;
	private guda.cms.entity.main.ChannelCount channelCount;

	// many to one
	private guda.core.entity.CmsSite site;
	private guda.cms.entity.main.CmsModel model;
	private guda.cms.entity.main.Channel parent;
	private guda.core.entity.CmsWorkflow workflow;

	// collections
	private java.util.Set<guda.cms.entity.main.Channel> child;
	private java.util.Set<guda.core.entity.CmsGroup> viewGroups;
	private java.util.Set<guda.core.entity.CmsGroup> contriGroups;
	private java.util.Set<guda.core.entity.CmsUser> users;
	private java.util.Set<guda.core.entity.CmsDepartment> departments;
	private java.util.Set<guda.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<guda.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public guda.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (guda.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public guda.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(guda.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public guda.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (guda.cms.entity.main.Channel parent) {
		this.parent = parent;
	}

	public guda.core.entity.CmsWorkflow getWorkflow() {
		return workflow;
	}

	public void setWorkflow(guda.core.entity.CmsWorkflow workflow) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<guda.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<guda.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<guda.core.entity.CmsUser> users) {
		this.users = users;
	}
	


	public java.util.Set<guda.core.entity.CmsDepartment> getDepartments() {
		return departments;
	}

	public void setDepartments(
			java.util.Set<guda.core.entity.CmsDepartment> departments) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<guda.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<guda.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<guda.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.main.Channel)) return false;
		else {
			guda.cms.entity.main.Channel channel = (guda.cms.entity.main.Channel) obj;
