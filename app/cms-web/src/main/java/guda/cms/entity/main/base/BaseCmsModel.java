...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<guda.cms.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<guda.cms.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.main.CmsModel)) return false;
		else {
			guda.cms.entity.main.CmsModel cmsModel = (guda.cms.entity.main.CmsModel) obj;
