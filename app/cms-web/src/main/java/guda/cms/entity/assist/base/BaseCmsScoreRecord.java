...
public abstract class BaseCmsScoreRecord  implements Serializable {
	...
	// many to one
	private guda.cms.entity.assist.CmsScoreItem item;
	 ...
	 */
	public guda.cms.entity.assist.CmsScoreItem getItem () {
		return item;
	}
	 ...
	 */
	public void setItem (guda.cms.entity.assist.CmsScoreItem item) {
		this.item = item;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsScoreRecord)) return false;
		else {
			guda.cms.entity.assist.CmsScoreRecord cmsScoreRecord = (guda.cms.entity.assist.CmsScoreRecord) obj;
