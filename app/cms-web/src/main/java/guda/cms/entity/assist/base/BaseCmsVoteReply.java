...
public abstract class BaseCmsVoteReply  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsVoteReply)) return false;
		else {
			guda.cms.entity.assist.CmsVoteReply cmsVoteReply = (guda.cms.entity.assist.CmsVoteReply) obj;
