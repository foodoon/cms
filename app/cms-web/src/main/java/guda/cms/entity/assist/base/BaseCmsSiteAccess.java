...
public abstract class BaseCmsSiteAccess  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSiteAccess)) return false;
		else {
			guda.cms.entity.assist.CmsSiteAccess cmsSiteAccess = (guda.cms.entity.assist.CmsSiteAccess) obj;
