...
public abstract class BaseCmsSiteAccessPages  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSiteAccessPages)) return false;
		else {
			guda.cms.entity.assist.CmsSiteAccessPages cmsSiteAccessPages = (guda.cms.entity.assist.CmsSiteAccessPages) obj;
