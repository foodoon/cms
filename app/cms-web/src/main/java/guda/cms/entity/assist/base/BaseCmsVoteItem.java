...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	// many to one
	private guda.cms.entity.assist.CmsVoteTopic topic;
	private guda.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public guda.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (guda.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public guda.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(guda.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof guda.cms.entity.assist.CmsVoteItem)) return false;
		else {
			guda.cms.entity.assist.CmsVoteItem cmsVoteItem = (guda.cms.entity.assist.CmsVoteItem) obj;
