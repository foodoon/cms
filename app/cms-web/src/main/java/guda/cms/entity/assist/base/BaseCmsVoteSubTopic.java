...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		guda.cms.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private guda.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<guda.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<guda.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public guda.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (guda.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<guda.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<guda.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			guda.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (guda.cms.entity.assist.CmsVoteSubTopic) obj;
