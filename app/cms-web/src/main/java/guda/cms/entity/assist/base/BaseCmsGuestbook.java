package guda.cms.entity.assist.base;
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		guda.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private guda.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private guda.core.entity.CmsUser member;
	private guda.core.entity.CmsUser admin;
	private guda.core.entity.CmsSite site;
	private guda.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public guda.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (guda.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public guda.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (guda.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public guda.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (guda.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public guda.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (guda.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsGuestbook)) return false;
		else {
			guda.cms.entity.assist.CmsGuestbook cmsGuestbook = (guda.cms.entity.assist.CmsGuestbook) obj;
