...
public abstract class BaseCmsSiteAccessStatistic  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSiteAccessStatistic)) return false;
		else {
			guda.cms.entity.assist.CmsSiteAccessStatistic cmsSiteAccessStatistic = (guda.cms.entity.assist.CmsSiteAccessStatistic) obj;
