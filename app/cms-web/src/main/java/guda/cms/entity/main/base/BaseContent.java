package guda.cms.entity.main.base;
...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private guda.cms.entity.main.ContentExt contentExt;
	private guda.cms.entity.main.ContentCount contentCount;

	// many to one
	private guda.cms.entity.main.ContentType type;
	private guda.core.entity.CmsSite site;
	private guda.core.entity.CmsUser user;
	private guda.cms.entity.main.Channel channel;
	private guda.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<guda.cms.entity.main.Channel> channels;
	private java.util.Set<guda.cms.entity.main.CmsTopic> topics;
	private java.util.Set<guda.core.entity.CmsGroup> viewGroups;
	private java.util.List<guda.cms.entity.main.ContentTag> tags;
	private java.util.List<guda.cms.entity.main.ContentPicture> pictures;
	private java.util.List<guda.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<guda.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<guda.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Set<guda.cms.entity.main.ContentDoc> contentDocSet;
	private java.util.Set<guda.core.entity.CmsWorkflowEvent> eventSet;
	private java.util.Set<guda.cms.entity.main.ContentShareCheck> contentShareCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<guda.core.entity.CmsUser> collectUsers;
	private java.util.Set<guda.cms.entity.assist.CmsComment> comments;
	private java.util.Set<guda.cms.entity.assist.CmsFile> files;
	private java.util.Set<guda.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<guda.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	...
	public java.util.Set<guda.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<guda.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<guda.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<guda.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<guda.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<guda.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	 ...
	 */
	public guda.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (guda.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public guda.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (guda.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public guda.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (guda.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public guda.core.entity.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (guda.core.entity.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public guda.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (guda.cms.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public guda.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(guda.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<guda.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<guda.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<guda.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<guda.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<guda.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<guda.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<guda.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<guda.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<guda.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<guda.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<guda.cms.entity.main.ContentCheck> contentCheckSet) {
		this.contentCheckSet = contentCheckSet;
	}

	public java.util.Set<guda.cms.entity.main.ContentDoc> getContentDocSet() {
		return contentDocSet;
	}

	public void setContentDocSet(
			java.util.Set<guda.cms.entity.main.ContentDoc> contentDocSet) {
		this.contentDocSet = contentDocSet;
	}
	
	public java.util.Set<guda.core.entity.CmsWorkflowEvent> getEventSet() {
		return eventSet;
	}

	public void setEventSet(
			java.util.Set<guda.core.entity.CmsWorkflowEvent> eventSet) {
		this.eventSet = eventSet;
	}

	public java.util.Set<guda.cms.entity.main.ContentShareCheck> getContentShareCheckSet() {
		return contentShareCheckSet;
	}

	public void setContentShareCheckSet(
			java.util.Set<guda.cms.entity.main.ContentShareCheck> contentShareCheckSet) {
	...
	public java.util.Set<guda.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<guda.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<guda.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<guda.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.main.Content)) return false;
		else {
			guda.cms.entity.main.Content content = (guda.cms.entity.main.Content) obj;
