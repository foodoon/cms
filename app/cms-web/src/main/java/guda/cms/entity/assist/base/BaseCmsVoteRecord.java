...
public abstract class BaseCmsVoteRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsVoteRecord)) return false;
		else {
			guda.cms.entity.assist.CmsVoteRecord cmsVoteRecord = (guda.cms.entity.assist.CmsVoteRecord) obj;
