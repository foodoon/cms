...
public abstract class BaseCmsMessage  implements Serializable {
	...
	public BaseCmsMessage (
		...
		guda.core.entity.CmsUser msgReceiverUser,
		guda.core.entity.CmsUser msgSendUser,
	...
	// many to one
	private guda.core.entity.CmsUser msgReceiverUser;
	private guda.core.entity.CmsUser msgSendUser;
	private guda.core.entity.CmsSite site;
	
	// collections
	private java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public guda.core.entity.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (guda.core.entity.CmsUser msgReceiverUser) {
	 ...
	 */
	public guda.core.entity.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (guda.core.entity.CmsUser msgSendUser) {
	...
	public java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof guda.cms.entity.assist.CmsMessage)) return false;
		else {
			guda.cms.entity.assist.CmsMessage cmsMessage = (guda.cms.entity.assist.CmsMessage) obj;
