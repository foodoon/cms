...
public abstract class BaseCmsScoreGroup  implements Serializable {
	...
	// collections
	private java.util.Set<guda.cms.entity.assist.CmsScoreItem> items;
	 ...
	 */
	public java.util.Set<guda.cms.entity.assist.CmsScoreItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<guda.cms.entity.assist.CmsScoreItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsScoreGroup)) return false;
		else {
			guda.cms.entity.assist.CmsScoreGroup cmsScoreGroup = (guda.cms.entity.assist.CmsScoreGroup) obj;
