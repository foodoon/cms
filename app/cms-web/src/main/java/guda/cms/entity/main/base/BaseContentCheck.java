...
public abstract class BaseContentCheck  implements Serializable {
	...
	private guda.core.entity.CmsUser reviewer;
	...
	public guda.core.entity.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(guda.core.entity.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.main.ContentCheck)) return false;
		else {
			guda.cms.entity.main.ContentCheck contentCheck = (guda.cms.entity.main.ContentCheck) obj;
