...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			guda.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (guda.cms.entity.assist.CmsSiteFlow) obj;
