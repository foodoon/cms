...
public abstract class BaseCmsComment  implements Serializable {
	...
	// one to one
	private guda.cms.entity.assist.CmsCommentExt commentExt;

	// many to one
	private guda.core.entity.CmsUser replayUser;
	private guda.cms.entity.main.Content content;
	private guda.core.entity.CmsUser commentUser;
	 ...
	 */
	public guda.cms.entity.assist.CmsCommentExt getCommentExt () {
		return commentExt;
	}
	 ...
	 */
	public void setCommentExt (guda.cms.entity.assist.CmsCommentExt commentExt) {
	 ...
	 */
	public guda.core.entity.CmsUser getReplayUser () {
		return replayUser;
	}
	 ...
	 */
	public void setReplayUser (guda.core.entity.CmsUser replayUser) {
	 ...
	 */
	public guda.cms.entity.main.Content getContent () {
		return content;
	}
	 ...
	 */
	public void setContent (guda.cms.entity.main.Content content) {
	 ...
	 */
	public guda.core.entity.CmsUser getCommentUser () {
		return commentUser;
	}
	 ...
	 */
	public void setCommentUser (guda.core.entity.CmsUser commentUser) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsComment)) return false;
		else {
			guda.cms.entity.assist.CmsComment cmsComment = (guda.cms.entity.assist.CmsComment) obj;
