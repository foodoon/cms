...
public abstract class BaseCmsSensitivity  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSensitivity)) return false;
		else {
			guda.cms.entity.assist.CmsSensitivity cmsSensitivity = (guda.cms.entity.assist.CmsSensitivity) obj;
