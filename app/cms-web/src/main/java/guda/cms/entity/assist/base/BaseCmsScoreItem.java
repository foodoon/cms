...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		...
		guda.cms.entity.assist.CmsScoreGroup group,
	...
	// many to one
	private guda.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<guda.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public guda.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (guda.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<guda.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<guda.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsScoreItem)) return false;
		else {
			guda.cms.entity.assist.CmsScoreItem cmsScoreItem = (guda.cms.entity.assist.CmsScoreItem) obj;
