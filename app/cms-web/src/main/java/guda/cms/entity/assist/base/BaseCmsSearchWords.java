...
public abstract class BaseCmsSearchWords  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsSearchWords)) return false;
		else {
			guda.cms.entity.assist.CmsSearchWords cmsSearchWords = (guda.cms.entity.assist.CmsSearchWords) obj;
