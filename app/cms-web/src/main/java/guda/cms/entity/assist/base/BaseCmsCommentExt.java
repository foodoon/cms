...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	// one to one
	private guda.cms.entity.assist.CmsComment comment;
	 ...
	 */
	public guda.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (guda.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.cms.entity.assist.CmsCommentExt)) return false;
		else {
			guda.cms.entity.assist.CmsCommentExt cmsCommentExt = (guda.cms.entity.assist.CmsCommentExt) obj;
