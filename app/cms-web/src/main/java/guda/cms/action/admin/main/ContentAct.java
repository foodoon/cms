...
import guda.cms.manager.main.CmsModelItemMng;
import guda.cms.manager.main.CmsModelMng;
...
import guda.common.image.ImageUtils;
import guda.common.office.FileUtils;
import guda.common.office.OpenOfficeConverter;
import guda.common.page.Pagination;
import guda.common.upload.FileRepository;
import guda.common.upload.UploadUtils;
import guda.common.util.StrUtils;
	...
	@RequestMapping("/content/o_copy.do")
		...
		if (contentIds != null) {
			for(Integer contentId:contentIds){
				...
				manager.save(beanCopy, extCopy, txtCopy, docCopy, bean.getChannelIdsWithoutChannel(),
