...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		guda.core.entity.CmsConfig config,
	...
	// many to one
	private guda.core.entity.Ftp uploadFtp;
	private guda.core.entity.CmsConfig config;
	// one to one
	private guda.core.entity.CmsSiteCompany siteCompany;
	private guda.core.entity.CmsSite parent;
	...
	private java.util.Set<guda.cms.entity.assist.CmsSiteAccessCount> accessCounts;
	private java.util.Set<guda.cms.entity.assist.CmsSiteAccess> accesses;
	private java.util.Set<guda.cms.entity.assist.CmsSiteAccessPages> accessPages;
	private java.util.Set<guda.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics;
	 ...
	 */
	public guda.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (guda.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public guda.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (guda.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public guda.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(guda.core.entity.CmsSiteCompany siteCompany) {
		this.siteCompany = siteCompany;
	}

	public guda.core.entity.CmsSite getParent() {
		return parent;
	}

	public void setParent(guda.core.entity.CmsSite parent) {
		this.parent = parent;
	}
	...
	public void setUserSites(
			java.util.Set<guda.core.entity.CmsUserSite> userSites) {
	...
	public java.util.Set<guda.cms.entity.assist.CmsSiteAccessCount> getAccessCounts() {
		return accessCounts;
	}

	public void setAccessCounts(
			java.util.Set<guda.cms.entity.assist.CmsSiteAccessCount> accessCounts) {
		this.accessCounts = accessCounts;
	}

	public java.util.Set<guda.cms.entity.assist.CmsSiteAccess> getAccesses() {
		return accesses;
	}

	public void setAccesses(
			java.util.Set<guda.cms.entity.assist.CmsSiteAccess> accesses) {
		this.accesses = accesses;
	}

	public java.util.Set<guda.cms.entity.assist.CmsSiteAccessPages> getAccessPages() {
		return accessPages;
	}

	public void setAccessPages(
			java.util.Set<guda.cms.entity.assist.CmsSiteAccessPages> accessPages) {
		this.accessPages = accessPages;
	}

	public java.util.Set<guda.cms.entity.assist.CmsSiteAccessStatistic> getAccessStatistics() {
		return accessStatistics;
	}

	public void setAccessStatistics(
			java.util.Set<guda.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics) {
		this.accessStatistics = accessStatistics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof guda.core.entity.CmsSite)) return false;
		else {
			guda.core.entity.CmsSite cmsSite = (guda.core.entity.CmsSite) obj;
