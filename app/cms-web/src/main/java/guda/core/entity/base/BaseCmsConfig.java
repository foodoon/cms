...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 guda.core.entity.MarkConfig m_markConfig;
	 guda.core.entity.EmailConfig m_emailConfig;
	...
	public guda.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (guda.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public guda.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (guda.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsConfig)) return false;
		else {
			guda.core.entity.CmsConfig cmsConfig = (guda.core.entity.CmsConfig) obj;
