...
public abstract class BaseCmsWorkflowEvent  implements Serializable {
	...
	private guda.core.entity.CmsUser initiator;

	// collections
	private java.util.Set<guda.core.entity.CmsWorkflowRecord> records;
	private java.util.Set<guda.core.entity.CmsWorkflowEventUser> users;
	 ...
	 */
	public guda.core.entity.CmsUser getInitiator () {
		return initiator;
	}
	 ...
	 */
	public void setInitiator (guda.core.entity.CmsUser initiator) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsWorkflowRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<guda.core.entity.CmsWorkflowRecord> records) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsWorkflowEventUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<guda.core.entity.CmsWorkflowEventUser> users) {
		this.users = users;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsWorkflowEvent)) return false;
		else {
			guda.core.entity.CmsWorkflowEvent cmsWorkflowEvent = (guda.core.entity.CmsWorkflowEvent) obj;
