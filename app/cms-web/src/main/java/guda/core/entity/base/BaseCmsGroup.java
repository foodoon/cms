...
public abstract class BaseCmsGroup  implements Serializable {
	...
	// collections
	private java.util.Set<guda.cms.entity.main.Channel> viewChannels;
	private java.util.Set<guda.cms.entity.main.Channel> contriChannels;
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.Channel> getViewChannels () {
		return viewChannels;
	}
	 ...
	 */
	public void setViewChannels (java.util.Set<guda.cms.entity.main.Channel> viewChannels) {
	 ...
	 */
	public java.util.Set<guda.cms.entity.main.Channel> getContriChannels () {
	 ...
	 */
	public void setContriChannels (java.util.Set<guda.cms.entity.main.Channel> contriChannels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsGroup)) return false;
		else {
			guda.core.entity.CmsGroup cmsGroup = (guda.core.entity.CmsGroup) obj;
