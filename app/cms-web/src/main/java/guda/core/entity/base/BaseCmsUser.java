...
public abstract class BaseCmsUser  implements Serializable {
	...
	public BaseCmsUser (
		...
		guda.core.entity.CmsGroup group,
	...
	// many to one
	private guda.core.entity.CmsGroup group;
	private guda.core.entity.CmsDepartment department;

	// collections
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<guda.core.entity.CmsUserExt> userExtSet;
	private java.util.Set<guda.core.entity.CmsUserSite> userSites;
	private java.util.Set<guda.core.entity.CmsRole> roles;
	private java.util.Set<guda.cms.entity.main.Channel> channels;
	private java.util.Set<guda.cms.entity.main.Content> collectContents;
	
	private java.util.Set<guda.cms.entity.assist.CmsMessage> sendMessages;
	private java.util.Set<guda.cms.entity.assist.CmsMessage> receivMessages;
	private java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages;
	private java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages;
	
	private java.util.Set<guda.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<guda.core.entity.CmsUserResume> userResumeSet;
	private java.util.Set<CmsLog> logs;
	private java.util.Set<guda.cms.entity.assist.CmsUserMenu> menus;
	private java.util.Set<guda.core.entity.CmsWorkflowEventUser> eventUsers;
	private java.util.Set<guda.core.entity.CmsWorkflowRecord> checkRecords;
	 ...
	 */
	public guda.core.entity.CmsGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (guda.core.entity.CmsGroup group) {
		this.group = group;
	}

	public guda.core.entity.CmsDepartment getDepartment() {
		return department;
	}

	public void setDepartment(guda.core.entity.CmsDepartment department) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsUserExt> getUserExtSet () {
		return userExtSet;
	}
	 ...
	 */
	public void setUserExtSet (java.util.Set<guda.core.entity.CmsUserExt> userExtSet) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsUserSite> getUserSites () {
		return userSites;
	}
	 ...
	 */
	public void setUserSites (java.util.Set<guda.core.entity.CmsUserSite> userSites) {
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsRole> getRoles () {
		return roles;
	}
	 ...
	 */
	public void setRoles (java.util.Set<guda.core.entity.CmsRole> roles) {
		this.roles = roles;
	}
	...
	public java.util.Set<guda.cms.entity.main.Content> getCollectContents() {
		return collectContents;
	}

	public void setCollectContents(
			java.util.Set<guda.cms.entity.main.Content> collectContents) {
		this.collectContents = collectContents;
	}
	
	public java.util.Set<guda.cms.entity.assist.CmsMessage> getSendMessages() {
		return sendMessages;
	}

	public void setSendMessages(
			java.util.Set<guda.cms.entity.assist.CmsMessage> sendMessages) {
		this.sendMessages = sendMessages;
	}

	public java.util.Set<guda.cms.entity.assist.CmsMessage> getReceivMessages() {
		return receivMessages;
	}

	public void setReceivMessages(
			java.util.Set<guda.cms.entity.assist.CmsMessage> receivMessages) {
		this.receivMessages = receivMessages;
	}

	public java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> getSendReceiverMessages() {
		return sendReceiverMessages;
	}

	public void setSendReceiverMessages(
			java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages) {
		this.sendReceiverMessages = sendReceiverMessages;
	}

	public java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> getReceivReceiverMessages() {
		return receivReceiverMessages;
	}

	public void setReceivReceiverMessages(
			java.util.Set<guda.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages) {
	...
	public java.util.Set<guda.core.entity.CmsUserResume> getUserResumeSet() {
			return userResumeSet;
		}
	
	public void setUserResumeSet(
				java.util.Set<guda.core.entity.CmsUserResume> userResumeSet) {
	...
	public java.util.Set<guda.cms.entity.assist.CmsUserMenu> getMenus() {
		return menus;
	}

	public void setMenus(
			java.util.Set<guda.cms.entity.assist.CmsUserMenu> menus) {
		this.menus = menus;
	}

	public java.util.Set<guda.core.entity.CmsWorkflowEventUser> getEventUsers() {
		return eventUsers;
	}

	public void setEventUsers(
			java.util.Set<guda.core.entity.CmsWorkflowEventUser> eventUsers) {
		this.eventUsers = eventUsers;
	}

	public java.util.Set<guda.core.entity.CmsWorkflowRecord> getCheckRecords() {
		return checkRecords;
	}

	public void setCheckRecords(
			java.util.Set<guda.core.entity.CmsWorkflowRecord> checkRecords) {
		this.checkRecords = checkRecords;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof guda.core.entity.CmsUser)) return false;
		else {
			guda.core.entity.CmsUser cmsUser = (guda.core.entity.CmsUser) obj;
