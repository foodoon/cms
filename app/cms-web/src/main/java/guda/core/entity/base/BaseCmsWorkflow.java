...
public abstract class BaseCmsWorkflow  implements Serializable {
	...
	// collections
	private java.util.List<guda.core.entity.CmsWorkflowNode> nodes;
	private java.util.Set<guda.core.entity.CmsWorkflowEvent> events;
	 ...
	 */
	public java.util.List<guda.core.entity.CmsWorkflowNode> getNodes () {
		return nodes;
	}
	 ...
	 */
	public void setNodes (java.util.List<guda.core.entity.CmsWorkflowNode> nodes) {
		this.nodes = nodes;
	}
	 ...
	 */
	public java.util.Set<guda.core.entity.CmsWorkflowEvent> getEvents () {
		return events;
	}
	 ...
	 */
	public void setEvents (java.util.Set<guda.core.entity.CmsWorkflowEvent> events) {
		this.events = events;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsWorkflow)) return false;
		else {
			guda.core.entity.CmsWorkflow cmsWorkflow = (guda.core.entity.CmsWorkflow) obj;
