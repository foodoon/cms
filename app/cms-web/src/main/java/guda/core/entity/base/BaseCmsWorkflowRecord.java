...
public abstract class BaseCmsWorkflowRecord  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsWorkflowRecord)) return false;
		else {
			guda.core.entity.CmsWorkflowRecord cmsWorkflowRecord = (guda.core.entity.CmsWorkflowRecord) obj;
