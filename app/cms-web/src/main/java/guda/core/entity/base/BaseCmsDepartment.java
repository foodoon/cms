...
public abstract class BaseCmsDepartment  implements Serializable {
	...
	private guda.core.entity.CmsDepartment parent;

	// collections
	private java.util.Set<guda.core.entity.CmsDepartment> child;
	private java.util.Set<guda.cms.entity.main.Channel> channels;
	private java.util.Set<guda.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs;
	...
	public guda.core.entity.CmsDepartment getParent() {
		return parent;
	}

	public void setParent(guda.core.entity.CmsDepartment parent) {
		this.parent = parent;
	}

	public java.util.Set<guda.core.entity.CmsDepartment> getChild() {
		return child;
	}

	public void setChild(
			java.util.Set<guda.core.entity.CmsDepartment> child) {
		this.child = child;
	}
	/**
	 ...
	 */
	public java.util.Set<guda.cms.entity.assist.CmsGuestbookCtg> getGuestBookCtgs () {
	 ...
	 */
	public void setGuestBookCtgs (java.util.Set<guda.cms.entity.assist.CmsGuestbookCtg> guestBookCtgs) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof guda.core.entity.CmsDepartment)) return false;
		else {
			guda.core.entity.CmsDepartment cmsDepartment = (guda.core.entity.CmsDepartment) obj;
